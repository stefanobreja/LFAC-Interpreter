...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 15 "proiect.y" /* yacc.c:1646  */
    {print("%f\n",(yyvsp[0].f));}
#line 1213 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 17 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[-2].f) + (yyvsp[0].f);}
#line 1219 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 18 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[-2].f) - (yyvsp[0].f);}
#line 1225 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 19 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[0].f);}
#line 1231 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 22 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[-2].f) * (yyvsp[0].f);}
#line 1237 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 23 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[-2].f) / (yyvsp[0].f);}
#line 1243 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 24 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[0].f);}
#line 1249 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 27 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[-1].f);}
#line 1255 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 28 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = -(yyvsp[0].f);}
#line 1261 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 29 "proiect.y" /* yacc.c:1646  */
    {(yyval.f) = (yyvsp[0].f);}
